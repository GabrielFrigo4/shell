...
"
	...
	PS1="${PS1}${_newline}${_delimiter}┌──❮${_theme_color_cyan} ${_time}${_delimiter}❯─❮${_theme_color_blue} ${_date}${_delimiter}❯─❮${_theme_color_yellow} ${_theme_color_cyan}${_pwd}${_delimiter}❯─ ❮${_theme_color_blue} ${_user_color}${_user}${_delimiter}❯${_git_info}"
