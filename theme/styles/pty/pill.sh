...
_theme_render() {
	...
	PS1="${_theme_color_delimiter}${_os_color}${_os_icon}${_theme_color_magenta}${_os_name} ${_theme_color_blue} ${_theme_color_magenta}${_shell_name}${_theme_color_delimiter} ${_theme_color_yellow} ${_theme_color_blue}${_pwd} ${_user_icon_color:-${_theme_color_blue}} ${_user_color}${_user}${_git_info} ${_terminal_color}${_theme_color_reset} "
