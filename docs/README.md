...
| Documento                              | Descrição                                                                                                                                                         |
| :------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **[ARCHITECTURE.md](ARCHITECTURE.md)** | Ciclo de boot da sessão, cascata de sourcing (`library/` ➔ `core/` ➔ `target/` ➔ `theme/`), princípios de latência mínima (&lt; 64ms) e regra do silêncio.        |
