...
- **The Linux Kernel Archives:** <https://www.kernel.org/> | Documentação: <https://www.kernel.org/doc/html/latest/>
- **GNU Bash (Chet Ramey's Official Site):** <https://tiswww.case.edu/php/chet/bash/bashtop.html>
- **FreeDesktop.org Specifications:** <https://specifications.freedesktop.org/> | Base Directory Spec: <https://specifications.freedesktop.org/basedir-spec/basedir-spec-latest.html>
- **Debian Almquist Shell (Dash):** <http://gondor.apana.org.au/~herbert/dash/>
- **Literatura Técnica:**
    - _The Linux Programming Interface: A Linux and UNIX System Programming Handbook_ (Michael Kerrisk, 2010, No Starch Press).
